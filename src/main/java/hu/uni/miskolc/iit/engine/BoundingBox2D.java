...
import hu.uni.miskolc.iit.engine.math.MATRIX4X4;
import hu.uni.miskolc.iit.engine.math.Vector2D;
import hu.uni.miskolc.iit.engine.math.Vector3D;
...
public class BoundingBox2D {
    ...
    /// Constructor
    ///
    public BoundingBox2D(Vector2D minpoint2, Vector2D maxPoint2) {
    ...
    public void Draw() {
        ...
        Renderer.mRenderer.lineShader.setUniform(PROJECTION_MATRIX, Renderer.mRenderer.projectionMatrix);

        // Set world/model matrix for this item
        Matrix4f modelMatrix = new Matrix4f();
        Renderer.mRenderer.lineShader.setUniform(MODEL_MATRIX, modelMatrix);

        // Set color
        Renderer.mRenderer.lineShader.setUniform4f(LINE_COLOR, 0.8f, 0.4f, 0.4f, 1.0f);
    ...
    public boolean CheckOverlapping(BoundingBox2D box) {
        ...
        // No collision
        return !(maxpoint.y < box.GetMinPoint().y) && !(minpoint.y > box.GetMaxPoint().y);
    }
